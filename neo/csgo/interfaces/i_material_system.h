...
public:
    ...
    virtual create_interface_fn               Init(char const* pShaderAPIDLL, IMaterialProxyFactory* pMaterialProxyFactory, create_interface_fn fileSystemFactory, create_interface_fn cvarFactory = NULL) = 0;
    ...
    virtual i_material* CreateMaterial(const char* pMaterialName, KeyValues* pVMTKeyValues) = 0;
    virtual i_material* find_material(char const* pMaterialName, const char* pTextureGroupName = nullptr, bool complain = true, const char* pComplainPrefix = NULL) = 0;
    virtual void							unk0() = 0;
