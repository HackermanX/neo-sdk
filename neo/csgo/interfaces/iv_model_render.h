...
public:
    ...
    virtual void                    forced_material_override(i_material* newMaterial, OverrideType_t nOverrideType = 0, int nOverrides = 0) = 0;
    ...
    virtual void                    AddDecal(ModelInstanceHandle_t handle, Ray_t const& ray, vec3_t const& decalUp, int decalIndex, int body, bool noPokeThru, int maxLODToDecal) = 0;
    ...
    virtual void                    SetupLightingEx(const vec3_t& vecCenter, ModelInstanceHandle_t handle) = 0;
    virtual bool                    GetBrightestShadowingLightSource(const vec3_t& vecCenter, vec3_t& lightPos, vec3_t& lightBrightness, bool bAllowNonTaggedLights) = 0;
